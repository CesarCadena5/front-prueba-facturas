...
const CrearFactura = () => {
    ...
    const { msgFacturas, iconFacturas, loadingFacturas } = useSelector(state => state.facturas);
    ...
    const onSubmit = (data) => {
        ...
        Swal.fire({
            title: "¿Estás seguro?",
            text: "Guardar la factura " + data.numero_factura,
            icon: "warning",
            ...
            if (result.isConfirmed) {
                dispatch(facturasFetch(`${import.meta.env.VITE_API_URL}facturas/crear`, JSON.stringify(data), 'POST'));
            };
        });
                ...
                <div className="col-12 col-sm-8 col-md-8 shadow p-4 rounded">
                    <form className="row g-3" encType="multipart/form-data" onSubmit={handleSubmit(onSubmit)}>
                        <div className="col-md-6">
                            ...
                            })} className="form-control" id="numero_factura" name='numero_factura' placeholder="12345678" />
                            {
                        ...
                        <div className="col-md-6">
                            ...
                            <select id="emisor" {...register('nombre_emisor', { required: { value: true, message: 'El emisor, es requerido.' } })} className="form-select" defaultValue=''>
                        ...
                        <div className="col-md-6">
                            ...
                            <select id="receptor" {...register('nombre_receptor', { required: { value: true, message: 'El receptor, es requerido.' } })} className="form-select" defaultValue=''>
                                <option value=''>Elige uno</option>
                                {
                        ...
                        <div className="col-md-6">
                            ...
                            })} className="form-control" id="fecha_hora" />
                            {
                                errors.fecha_hora && (
                        ...
                        <div className="col-md-6">
                            ...
                            })} className="form-control" id="valor_antes_iva" placeholder='1200' />
                            {
                        ...
                        <div className="col-md-6">
                            ...
                            })} className="form-control" id="iva" placeholder='10' />
                            {
                                errors.iva && (
